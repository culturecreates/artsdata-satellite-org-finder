class OrgVignette extends HTMLElement {
  set org(org) {
    ...
    this.innerHTML = `
      ...
      <a ${org.id[0] != "K" ? "" : "href='http://kg.artsdata.ca/resource/" + encodeURIComponent(org.id) + "'"} class="${org.match && org.id[0] == "K" && "list-group-item-primary" } list-group-item list-group-item-action d-flex justify-content-between align-items-start">
